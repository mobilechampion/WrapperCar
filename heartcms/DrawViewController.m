...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSArray *arr2 = [NSArray arrayWithObjects:@"Matte Red",@"Gloss Purple", nil];
    NSArray *arr2_name = [NSArray arrayWithObjects:@"bmw_5",@"bmw_6", nil];
    NSArray *arr3 = [NSArray arrayWithObjects:@"Gloss Green",@"Gloss Orange",@"Matte Blue", nil];
    NSArray *arr3_name = [NSArray arrayWithObjects:@"gtr-limegreen",@"gtr-orange",@"gtr-matteblue", nil];
    

    NSArray *arr4 = [NSArray arrayWithObjects:@"Gloss Blue",@"Gloss Purple",@"Matte Brown", nil];
    NSArray *arr4_name = [NSArray arrayWithObjects:@"ka-lightblue",@"ka-metallic-purple",@"ka-matte-brown",nil];
    ...
    NSArray *arr6 = [NSArray arrayWithObjects:@"Matte metallic Brown", @"Gloss Orange",@"Gloss yellow", nil];
    NSArray *arr6_name = [NSArray arrayWithObjects:@"BMW-M4-matteBrown", @"BMW-M4-Orange",@"BMW-M4-Yellow", nil];
    NSArray *arr7 = [NSArray arrayWithObjects:@"Gloss Grey", @"Gloss Red", nil];
    NSArray *arr7_name = [NSArray arrayWithObjects:@"VWGolfMatteGrey", @"VWGolfRed", nil];
    
    
    
    
    na_category_key = [NSArray arrayWithObjects:arr4,arr5,arr7,arr6,arr3,arr1,arr2, nil];
    na_category_key_name = [NSArray arrayWithObjects:arr4_name,arr5_name,arr7_name,arr6_name,arr3_name,arr1_name,arr2_name, nil];
